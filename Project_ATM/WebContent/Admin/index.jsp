            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="../ShowAllUsersServlet">Show all users</a>
                        </li>
                        <li>
                            <a href="../UsersRegistration/index.jsp">Create User</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="../DepositReportServlet">
                        <i class="far fa-file"></i>
                        Deposit Report
                    </a>
                </li>
                <li>
                    <a href="../WithdrawalReportServlet">
                        <i class="far fa-file"></i>
                        Withdrawal Report
                    </a>
                </li>
                <li>
                    <a href="../TransactionReportServlet">
                        <i class="far fa-file"></i>
                        Transaction Report
                    </a>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl">
                        <div class="stat-grid p-3 d-flex align-items-center justify-content-between bg-primary">
                            <div class="s-l">
                                <h5>Users</h5>
                                <p class="paragraph-agileits-w3layouts text-white">Total number of account holders</p>
                            </div>
                            <div class="s-r">
                                <h6>340  <!-- this value will be fetched from database -->
